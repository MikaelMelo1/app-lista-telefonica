  ...
  return (
    <ScrollView style={{ backgroundColor: "white" }}>
      <View style={styles.container}>
        ...
        <Text style={styles.intro}>
          Se você tiver alguma dúvida ou sugestão, por favor, não hesite em
          entrar em contato comigo clicando nas imagens abaixo.
        ...
        >
          ...
          <TouchableOpacity
            onPress={() =>
              Linking.openURL("mailto: mikaelsilva1940@hotmail.com")
            }
          >
            <Image
